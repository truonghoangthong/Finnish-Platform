...
const Part1Final = () => {
  ...
  const { score, answers, questions, userId, part1aViewed, part1aCorrect } =
    location.state || {};
  ...
  return (
    <div className="final-container">
      <h2>🎯 Lopputulos</h2>
      <p className="score">
        Pisteesi: {score} / {questions.length}
      </p>
      ...
      <div className="final-results">
        {questions.map((q, i) => (
          <div
            key={i}
            className={`final-box ${answers[i] === q.imageLink ? "correct" : "incorrect"}`}
          >
      ...
      <div className="final-buttons">
        ...
        <button onClick={() => navigate("/course/a1")}>
          🏠 Takaisin kurssille
        </button>
      </div>
    </div>
