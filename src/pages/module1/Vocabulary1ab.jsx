...
const Vocabulary1ab = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch('https://finnish-platform-thong-truongs-projects.vercel.app/api/studying/A1/the_break_room/module1/part1a');
        const json = await res.json();
        setDataA(json.result.part1a);

        const res2 = await fetch('https://finnish-platform-thong-truongs-projects.vercel.app/api/studying/A1/the_break_room/module1/part1b');
